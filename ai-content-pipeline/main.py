"""NovaMind Content Pipeline — CLI orchestrator.
...
def cmd_run(args):
    ...
    print(f"NovaMind pipeline | company={active_company()['name']} | {config.mode_banner()}")
...
def build_parser():
    p = argparse.ArgumentParser(description="NovaMind AI content pipeline")
